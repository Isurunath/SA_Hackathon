...
<!--    <link rel="stylesheet" type="text/css" href="--><?php //echo base_url(); ?><!--css/update">-->
</head>
<body>
<div id="container">
    <div id="wrapper">
        ...
        <div id="menu">
            ...
            <ol>
                <?php foreach ($students as $student): ?>
                    <li><a href="<?php echo base_url(); ?>updateController/show_user_id" . $student->user_id; ?>"><?php echo $student->user_name; ?></a></li>
                <?php endforeach; ?>
            </ol>
        </div>
      <!--  <div id="detail">
